...
# Temporary GPS blob replacement
PRODUCT_COPY_FILES += \
    device/htc/supersonic/prebuilt/lib/libgps.so:obj/lib/gps.supersonic.so \
    device/htc/supersonic/prebuilt/lib/libgps.so:system/lib/gps.supersonic.so
